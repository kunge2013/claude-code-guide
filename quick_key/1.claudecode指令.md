...
Claude Code 支持通过配置文件和自定义指令来扩展功能，满足个人或团队的特定需求。
...
- `pre-commit`: Git 提交前执行
- `post-commit`: Git 提交后执行
...
**模板示例** (`react-component.md`):
```markdown
# React 组件模板

创建一个名为 {{component_name}} 的 React 组件，要求：
- 使用 TypeScript
- 包含 Props 接口定义
- 添加基本的样式
- 包含错误处理
...
**使用示例**:
```
使用 react-component 模板创建一个 LoginForm 组件
```
