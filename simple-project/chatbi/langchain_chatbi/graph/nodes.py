...
async def schema_node(state: ChatBIState) -> Dict[str, Any]:
    """
...
async def reasoning_node(state: ChatBIState) -> Dict[str, Any]:
    """
...
async def sql_node(state: ChatBIState) -> Dict[str, Any]:
    """
    SQL generation node.
...
async def chart_node(state: ChatBIState) -> Dict[str, Any]:
    """
...
async def diagnosis_node(state: ChatBIState) -> Dict[str, Any]:
    """
...
async def answer_node(state: ChatBIState) -> Dict[str, Any]:
    """
